...
public class RegistrationForm {
    ...
    public void verifyFirstNameLengthTest(){
        ...
        BrowserUtils.wait(3);
        WebElement warningMessage = driver.findElement(By.xpath("//small[.='first name must be more than 2 and less than 64 characters long']"));
    ...
    public void verifyAlphabeticLettersOnlyTest(){
        ...
        BrowserUtils.wait(3);
        WebElement warningMessage = driver.findElement(By.xpath("//small[.='first name can only consist of alphabetical letters']"));
        Assert.assertTrue(warningMessage.isDisplayed());
    }
