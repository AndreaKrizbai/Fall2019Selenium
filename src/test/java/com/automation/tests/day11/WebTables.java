...
//    }
    ...
    //to have the browser invisible!!! with (true)
    ...
    public void deleteRowTest() {
        String deleteBtn = "//table[1]//td[text()='jsmith@gmail.com']/..//a[text()='delete']";
        driver.findElement(By.xpath(deleteBtn)).click();
        BrowserUtils.wait(2);
        //get count of rows
        int rowCount = driver.findElements(By.xpath("//table[1]//tbody//tr")).size();
        Assert.assertEquals(rowCount, 3);
        List<WebElement>email = driver.findElements(By.xpath("//table[1]//td[text()='jsmith@gmail.com']"));
